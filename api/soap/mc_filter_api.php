...
$g_soap_api_to_filter_names = array (
    'search' => FILTER_SEARCH_FREE_TEXT,
    'category' => FILTER_PROPERTY_CATEGORY,
    'severity_id' => FILTER_PROPERTY_SEVERITY_ID,
    'status_id' => FILTER_PROPERTY_STATUS_ID,
    'priority_id' => FILTER_PROPERTY_PRIORITY_ID,
    'reporter_id' => FILTER_PROPERTY_REPORTER_ID,
    'handler_id' => FILTER_PROPERTY_HANDLER_ID,
    'note_user_id' => FILTER_PROPERTY_NOTE_USER_ID,
    'resolution_id' => FILTER_PROPERTY_RESOLUTION_ID,
    'product_version' => FILTER_SEARCH_PRODUCT_VERSION,

    'user_monitor_id' => FILTER_PROPERTY_MONITOR_USER_ID,
    'hide_status_id' => FILTER_PROPERTY_HIDE_STATUS_ID,
    'sort' => FILTER_PROPERTY_SORT_FIELD_NAME,
    'sort_direction' => FILTER_PROPERTY_SORT_DIRECTION,
    'sticky' => FILTER_PROPERTY_SHOW_STICKY_ISSUES,
    'view_state' => FILTER_PROPERTY_VIEW_STATE_ID,
